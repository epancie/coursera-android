...
public class ActivityLoaderActivity extends Activity {
	...
	private void startImplicitActivation() {
		...
		// Verify the intent will resolve to at least one activity
	     ...
	     Log.i(TAG,"Possible activities for baseIntent:" +  activities.size());
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if(resultCode==Activity.RESULT_OK && requestCode ==GET_TEXT_REQUEST_CODE ){
			...
			try{
				...
				String text = data.getStringExtra("newtext");
				Log.i(TAG,"The result of other activity was" + text);
